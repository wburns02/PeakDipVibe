    ...
    <div className="mx-auto max-w-6xl space-y-6 px-4 py-6 sm:px-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="rounded-xl border border-border bg-bg-secondary p-3">
          <p className="text-sm uppercase tracking-wider text-text-muted">Stocks Scanned</p>
          <p className="mt-1 text-xl font-bold text-text-primary">
            {isLoading ? "\u2014" : squeezeStocks.length}
          </p>
        </div>
        <div className="rounded-xl border border-border bg-bg-secondary p-3">
          <p className="text-sm uppercase tracking-wider text-text-muted">In Squeeze</p>
        ...
        <div className="rounded-xl border border-border bg-bg-secondary p-3">
          <p className="text-sm uppercase tracking-wider text-text-muted">Fired Today</p>
        ...
        >
          <p className="text-sm uppercase tracking-wider text-text-muted">Vol Regime</p>
          <p className="mt-1 text-xl font-bold" style={{ color: regime.color }}>
            {isLoading ? "\u2014" : regime.label}
          </p>
          {!isLoading && <p className="text-sm text-text-muted">{regime.desc}</p>}
        </div>
      </div>
