  ...
  return (
    <div className="flex flex-wrap gap-3 sm:gap-4">
      ...
      <div className="flex items-center gap-2 rounded-lg border border-border bg-bg-card px-3 py-2">
        ...
        <div>
          <p className="text-[10px] font-medium uppercase tracking-wider text-text-muted">52W High</p>
      ...
      <div className="flex items-center gap-2 rounded-lg border border-border bg-bg-card px-3 py-2">
        ...
        <div>
          <p className="text-[10px] font-medium uppercase tracking-wider text-text-muted">52W Low</p>
      ...
      {stats.fromHigh != null && (
        <div className="flex items-center gap-2 rounded-lg border border-border bg-bg-card px-3 py-2">
          ...
          <div>
            <p className="text-[10px] font-medium uppercase tracking-wider text-text-muted">From High</p>
      ...
      {stats.avgVol != null && (
        <div className="flex items-center gap-2 rounded-lg border border-border bg-bg-card px-3 py-2">
          ...
          <div>
            <p className="text-[10px] font-medium uppercase tracking-wider text-text-muted">Avg Vol</p>
      ...
      {stats.dailyChange != null && (
        <div className="flex items-center gap-2 rounded-lg border border-border bg-bg-card px-3 py-2">
          ...
          <div>
            <p className="text-[10px] font-medium uppercase tracking-wider text-text-muted">Day Chg</p>
