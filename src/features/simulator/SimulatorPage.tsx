          ...
          <Card>
            <div className="mb-2 flex items-center justify-between">
              <h3 className="flex items-center gap-1.5 text-sm font-semibold text-text-primary">
                ...
                Past Simulations
                <span className="text-xs font-normal text-text-muted">({simHistory.length})</span>
              </h3>
              <button
                type="button"
                ...
                >
                  <div className="flex items-center gap-3">
                    <div>
                      ...
                      <span className="ml-1.5 text-xs text-text-muted">{h.interval}</span>
                    </div>
                    <span className="text-xs text-text-muted">
                  ...
                  <div className="flex items-center gap-3 text-right">
                    ...
                    <span className={`text-xs tabular-nums ${h.pnlPct >= 0 ? "text-emerald-400/70" : "text-red-400/70"}`}>
      ...
      {intradaySim && !("error" in intradaySim) && (
        <>
            ...
            <div className="flex flex-col items-center gap-2 sm:flex-row sm:justify-between">
              ...
              <div className="flex gap-4">
                <div className="text-center">
                  ...
                  <p className="text-xs text-text-muted">Gap Up</p>
                </div>
                <div className="text-center">
                  <p className="text-xl font-bold text-red-400">
                    -{(intradaySim.selloff_pct ?? 0).toFixed(1)}%
                  </p>
                  <p className="text-xs text-text-muted">Selloff</p>
                </div>
              </div>
            </div>
          </Card>
          ...
          <div className="flex items-center gap-1.5 rounded-xl border border-border bg-bg-card px-4 py-2.5">
            <span className="mr-1 text-xs font-medium text-text-muted">Phase:</span>
            {/* Phase 1: Pre-Event */}
            <div className={`flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-bold transition-colors ${
              currentPhase === 1
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {analysis.catalyst_type && (() => {
                        ...
                        return (
                          <span className={`rounded-full px-2 py-0.5 text-xs font-bold uppercase tracking-wider ${colorMap[cc.variant] ?? colorMap.default}`}>
                            {cc.label}
                          </span>
                        );
                      })()}
          ...
          <Card>
            ...
            <div className="mb-3">
              ...
              {paramsExpanded && (
                <div className="mt-2 grid grid-cols-2 gap-3 rounded-lg border border-border/50 bg-bg-hover/30 p-3 sm:grid-cols-5">
                  <div>
                    <label className="mb-1 flex items-center gap-1 text-xs font-medium text-red-400">
                    ...
                    />
                    <p className="mt-0.5 text-xs text-text-muted">0 = off</p>
                  </div>
                  <div>
                    <label className="mb-1 flex items-center gap-1 text-xs font-medium text-emerald-400">
                    ...
                    <input
                      ...
                      className="w-full rounded-md border border-border bg-bg-secondary px-2 py-2.5 text-sm text-text-primary outline-none focus:border-accent"
                    />
                    <p className="mt-0.5 text-xs text-text-muted">Sells half</p>
                  </div>
                  <div>
                    <label className="mb-1 flex items-center gap-1 text-xs font-medium text-emerald-400">
                      <Target className="h-3 w-3" />
                    ...
                    <input
                      ...
                      className="w-full rounded-md border border-border bg-bg-secondary px-2 py-2.5 text-sm text-text-primary outline-none focus:border-accent"
                    />
                    <p className="mt-0.5 text-xs text-text-muted">Sells rest</p>
                  </div>
                  <div>
                    <label className="mb-1 flex items-center gap-1 text-xs font-medium text-amber-400">
                    ...
                    <input
                      ...
                      className="w-full rounded-md border border-border bg-bg-secondary px-2 py-2.5 text-sm text-text-primary outline-none focus:border-accent"
                    />
                    <p className="mt-0.5 text-xs text-text-muted">From peak</p>
                  </div>
                  <div>
                    <label className="mb-1 flex items-center gap-1 text-xs font-medium text-accent">
                    ...
                    <input
                      ...
                      className="w-full rounded-md border border-border bg-bg-secondary px-2 py-2.5 text-sm text-text-primary outline-none focus:border-accent"
                    />
                    <p className="mt-0.5 text-xs text-text-muted">Of cash</p>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="mb-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
              <div className="rounded-lg bg-bg-hover/50 p-2.5">
                <p className="text-xs font-medium text-text-muted">Cash</p>
              ...
              <div className="rounded-lg bg-bg-hover/50 p-2.5">
                <p className="text-xs font-medium text-text-muted">P&L</p>
                <p
            ...
            {shares > 0 && avgCost > 0 && (
              <div className="mb-3 flex flex-wrap items-center gap-3 rounded-lg border border-border/40 bg-bg-hover/20 px-3 py-1.5 text-xs text-text-muted">
            ...
            <div className="mt-2 hidden items-center gap-3 text-xs text-text-muted md:flex">
              <span>Shortcuts:</span>
                    ...
                    <div className="mb-3 flex flex-wrap gap-2">
                      {aiData.references.map((ref) => (
                        <div
                          ...
                          className="flex items-center gap-1.5 rounded-full border border-border/50 bg-bg-hover/30 px-2.5 py-1 text-xs"
                        >
                    ...
                    return (
                      <div className={`mb-3 rounded-lg border p-3 ${actionColor}`}>
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`rounded-full px-2 py-0.5 text-xs font-bold uppercase ${actionBadge}`}>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {t.reason && t.reason !== "manual" && (
                          <span className={`rounded-full px-1.5 py-0.5 text-xs font-bold uppercase ${
                        ...
                        {tradePnl !== null && (
                          <span className={`text-xs font-bold tabular-nums ${tradePnl >= 0 ? "text-emerald-400" : "text-red-400"}`}>
              ...
              <div className="text-center">
                ...
                <div className="mx-auto mt-4 grid max-w-md grid-cols-2 gap-3">
                  <div className="rounded-lg bg-bg-hover/50 p-3">
                    <p className="text-xs text-text-muted">Started With</p>
                    <p className="text-sm font-bold text-text-primary">
    ...
    >
      <div className="flex items-start justify-between">
        <div>
          ...
          <span className="ml-1.5 rounded bg-bg-hover px-1.5 py-0.5 text-xs font-medium text-text-muted">
            {ev.gap_size}
          </span>
        </div>
        <div
          className={`flex items-center gap-1 rounded-full border px-2 py-0.5 text-xs font-bold ${outcomeBg}`}
        >
      ...
      <div className="mt-2">
        <div className="flex items-center gap-1.5">
          ...
          {ev.has_analysis && (
            <span className="flex items-center gap-0.5 rounded bg-indigo-500/15 px-1.5 py-0.5 text-xs font-bold text-indigo-400">
      ...
      <p className={`mt-2 flex-1 text-xs leading-relaxed ${ev.has_analysis ? "line-clamp-3 text-text-secondary" : "line-clamp-2 text-text-muted/80"}`}>
        {ev.summary}
      </p>
