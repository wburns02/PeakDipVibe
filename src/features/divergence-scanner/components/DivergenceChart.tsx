...
export function DivergenceChart({
  ...
  return (
    <div className="space-y-1">
      {/* Price panel */}
      <div>
        <p className="mb-0.5 text-[9px] uppercase tracking-wider text-text-muted">Price</p>
      ...
      {/* RSI panel */}
      <div>
        <p className="mb-0.5 text-[9px] uppercase tracking-wider text-text-muted">RSI (14)</p>
      ...
      <div className="flex items-center justify-center gap-3 pt-0.5">
        <div className="flex items-center gap-1">
          ...
          <span className="text-[8px] text-text-muted">Price</span>
        </div>
        <div className="flex items-center gap-1">
          <div className="h-1.5 w-3 rounded-full" style={{ backgroundColor: "#818cf8" }} />
          <span className="text-[8px] text-text-muted">RSI</span>
        </div>
        <div className="flex items-center gap-1">
          <div className="h-2 w-2 rounded-full" style={{ backgroundColor: color }} />
          <span className="text-[8px] text-text-muted">Swing</span>
        </div>
      </div>
    </div>
  );
