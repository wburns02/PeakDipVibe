    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      {sectors.length > 0 && (
        <select
          ...
          className="rounded-lg border border-border bg-bg-card px-2.5 py-1.5 text-xs text-text-secondary outline-none transition-colors hover:border-accent/30 focus:border-accent/50"
        >
