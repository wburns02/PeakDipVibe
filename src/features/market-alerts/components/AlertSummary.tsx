  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        >
          <p className="text-sm font-semibold uppercase tracking-wider text-text-muted">Total Alerts</p>
          <p className="text-2xl font-bold text-text-primary">{alerts.length}</p>
        </button>
        <div className="rounded-xl border border-border bg-bg-card p-3">
          <p className="text-sm font-semibold uppercase tracking-wider text-text-muted">Watchlist Hits</p>
          <p className="text-2xl font-bold text-accent">{watchlistCount}</p>
        </div>
        <div className="rounded-xl border border-border bg-bg-card p-3">
          <p className="text-sm font-semibold uppercase tracking-wider text-text-muted">Critical</p>
        ...
        {displayTypes.map((type) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-1.5 rounded-lg border px-3 py-3 text-sm font-medium transition-all ${
                isActive
            ...
            >
              ...
              <span
                className="ml-0.5 rounded-full px-1.5 py-0.5 text-sm font-bold"
