  ...
  if (insights.length === 0) {
    return (
      <div className="rounded-2xl border border-border bg-bg-card p-5">
        ...
        <p className="text-xs text-text-muted">Notable relationships between your stocks</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className="ml-auto rounded-md px-1.5 py-0.5 text-xs font-mono font-semibold"
                      style={{ backgroundColor: meta.color + "18", color: meta.color }}
                    >
                      r={p.correlation > 0 ? "+" : ""}{p.correlation.toFixed(2)}
                    </span>
                  </div>
                  <p className="mt-0.5 text-xs text-text-muted">{p.label}</p>
