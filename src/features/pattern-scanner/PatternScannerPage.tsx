    ...
    <div className="mx-auto max-w-5xl space-y-6 px-4 py-6 sm:px-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="rounded-xl border border-border bg-bg-secondary p-3">
          <p className="text-sm uppercase tracking-wider text-text-muted">Patterns</p>
        ...
        <div className="rounded-xl border border-border bg-bg-secondary p-3">
          <p className="text-sm uppercase tracking-wider text-text-muted">Most Common</p>
          ...
          {!isLoading && topPattern && (
            <p className="text-sm text-text-muted">{topPattern[1]} detected</p>
          )}
        </div>
      </div>
