    ...
    <div className="overflow-hidden rounded-2xl border border-border bg-bg-secondary">
      ...
      <div className="flex items-center justify-between px-4 pt-3 pb-2">
        ...
        <div className="text-right">
          ...
          <div className="flex items-center gap-0.5 justify-end">
            ...
            <span className="ml-1 text-sm text-text-muted">{p.conviction}/5</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-px border-t border-border bg-border">
        <div className="bg-bg-secondary px-2 py-2 text-center">
          <p className="text-sm uppercase tracking-wider text-text-muted">Target</p>
        ...
        <div className="bg-bg-secondary px-2 py-2 text-center">
          <p className="text-sm uppercase tracking-wider text-text-muted">Stop</p>
          <p className="flex items-center justify-center gap-0.5">
        ...
        <div className="bg-bg-secondary px-2 py-2 text-center">
          <p className="text-sm uppercase tracking-wider text-text-muted">Potential</p>
          <p className={`text-xs font-bold ${isBull ? "text-green" : "text-red"}`}>
            {isBull ? "+" : "-"}{p.potentialPct.toFixed(1)}%
          </p>
        </div>
        <div className="bg-bg-secondary px-2 py-2 text-center">
          <p className="text-sm uppercase tracking-wider text-text-muted">R:R</p>
