        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {savedStrategies.length > 0 && (
              <span className="rounded-full bg-accent/10 px-1.5 text-xs font-semibold text-accent">
        ...
        <div className="rounded-xl border border-border bg-bg-card p-4 space-y-3 animate-slideDown">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-md text-text-muted hover:text-text-primary hover:bg-bg-hover"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
